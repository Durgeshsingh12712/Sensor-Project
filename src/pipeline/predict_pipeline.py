...
class PredictionPipeline:
    ...
    def get_predicted_dataframe(self, input_dataframe_path: pd.DataFrame):
        ...
        try:
            ...
            prediction_coloumn_name :str = TARGET_COLUMN
            ...
            input_dataframe[prediction_coloumn_name] = [pred for pred in predictions]

            target_column_mapping = {0:'bad',1: 'good'}

            input_dataframe[prediction_coloumn_name] = input_dataframe[prediction_coloumn_name].map(target_column_mapping)
